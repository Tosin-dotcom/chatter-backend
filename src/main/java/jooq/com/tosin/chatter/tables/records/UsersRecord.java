 ...
 */
package com.tosin.chatter.tables.records;
...
public class UsersRecord extends UpdatableRecordImpl<UsersRecord> implements Record7<UUID, String, String, String, String, LocalDateTime, LocalDateTime> {
    ...
    @Override
    public Row7<UUID, String, String, String, String, LocalDateTime, LocalDateTime> valuesRow() {
    ...
    @Override
    public UsersRecord values(UUID value1, String value2, String value3, String value4, String value5, LocalDateTime value6, LocalDateTime value7) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
    ...
    public UsersRecord(UUID id, String username, String email, String role, String password, LocalDateTime createdAt, LocalDateTime updatedAt) {
        super(Users.USERS);
     ...
     * Create a detached, initialised UsersRecord
     */
    public UsersRecord(com.tosin.chatter.tables.pojos.Users value) {
        super(Users.USERS);
